...
def read_CAGE_header():
    ...
    """
    header = pd.read_csv('../c08-combining/data/experiments/fantom/hg38_fair+new_CAGE_peaks_phase1and2_tpm_ann.osc.txt',
...
def read_samples_info():
    ...
    """
    samples_info_file_loc = '../c08-combining/data/experiments/fantom/fantom_humanSamples2.0.csv'
